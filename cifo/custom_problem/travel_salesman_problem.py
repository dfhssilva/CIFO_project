...
input = [   [0, 2451, 713, 1018, 1631, 1374, 2408, 213, 2571, 875, 1420, 2145, 1972],
...
class TravelSalesmanProblem( ProblemTemplate ):
    ...
    # Constructor
    #----------------------------------------------------------------------------------------------
    def __init__(self, decision_variables = tsp_decision_variables, constraints , encoding_rule = tsp_encoding_rule):
        """
        - Defines:
